...
public enum Sound {
    ...
    Sound(String... legacyNames) {
        this.legacyNames = legacyNames;
    }

    public final org.bukkit.Sound bukkitSound() {
        if (this.cachedSound != null) {
            return this.cachedSound;
        }
        for (String candidateName : this.legacyNames) {
            try {
                this.cachedSound = org.bukkit.Sound.valueOf(candidateName);
                return this.cachedSound;
